...
The number of available packages is another measure of R's popularity. Below shiny app is created to show you the number of R packages available via CRAN by now (Figure \@ref(fig:Rpacks)). The moment you opened this page, the app scanned CRAN to bring you the latest number and put it in a graph. You can brush points to see further details.
